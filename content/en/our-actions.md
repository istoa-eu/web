...
* [Dr. Geo](http://gnu.org/s/dr-geo), an interactive geometry and
  ...
  concept was developed for the field of geometry. It is actively used
  with lower secondary school students to introduce programming.
* iStoa.net (not publicly available), as part of a research project on
...
* Books to strengthen computer literacy through coding:
   ...
   * The Morph Books, [vol. I](https://drcuis.github.io/DesignGUI) &
     ...
     GUI applications within the Cuis-Smalltalk environment.
   * [Programming with
